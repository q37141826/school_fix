...
public class MaterialBadgeTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private static final float SHADOW_RADIUS = 0.1f; //2.0  除掉阴影
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MaterialBadgeTextView, 0, 0);
