...
//                    pvTime.show();
    ...
    private void showTimePicker(SelectedDataBean selectedPerson) {
        //                transToOther(TimeDataUtil.getTimeStamp(new Date().getTime(), TimeDataUtil.DEFULT_TIME_FORMAT));
...
//                transToOther(TimeDataUtil.getTimeStamp(new Date().getTime(), TimeDataUtil.DEFULT_TIME_FORMAT));
                transToOther(selectedDataBean.getText());
            }
        });
